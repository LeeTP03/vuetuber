...
const formattedDate = formatDate(props.data.published_at);
// const channel_site = 'https://www.youtube.com/channel/' + this.data.channel_id
</script>
      ...
      <div class="flex flex-row" >
        ...
        <div class="pl-2">
          <div class="line-clamp-2 w-full">{{ data.title }}</div>
            <div>
              <div class="text-pink-600 text-sm hover:bg-">{{ formattedDate }}</div>
            </div>
          </div>
        </div>
    </div>
